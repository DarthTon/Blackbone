...
namespace Testing
{
    ...
    public:
        ...
        {
            Assert::IsNotNull( _guard.get() );

            auto orig = _guard->pS2->pS1->pEnd->fval;
            Assert::AreEqual( 12.0f, orig, 0.001f );
            Assert::AreEqual( _guard->pS2->pS1->pEnd->ival + static_cast<int>(_guard->pS2->pS1->pEnd->fval), _guard->pS2->pS1->pEnd->fn3() );
        }
        ...
        TEST_METHOD( LocalStruct )
        {
            ...
            Assert::AreEqual( reinterpret_cast<uintptr_t>(_guard->pS2->pS1->pEnd), reinterpret_cast<uintptr_t>(pEnd) );
        }
        ...
        TEST_METHOD( LocalFloat )
        {
            ...
            *float_ptr = 15.7f;
            ...
            Assert::AreEqual( pEnd->fval, newVal, 0.001f );
        }
        ...
        TEST_METHOD( LocalMethod )
        {
            ...
            Assert::AreEqual( pEnd->ival + static_cast<int>(pEnd->fval), func_ptr( pEnd, nullptr ) );
        }
        ...
        TEST_METHOD( Remote )
        {
            ...
            Assert::IsNotNull( pVal_ex );
            AssertEx::IsNotZero( pVal_ex->fval );

            pVal_ex->fval = 25.0;
            Assert::AreEqual( STATUS_SUCCESS, ptr_ex.commit() );
            pVal_ex = ptr_ex.get();

            Assert::IsNotNull( pVal_ex );
            Assert::AreEqual( newVal, pVal_ex->fval, 0.001f );
        }
