...
struct HookHandler<R( __fastcall* )(Args...), C> : public DetourBase
{
    ...
    typedef typename R( __fastcall *type )(Args...);
    typedef typename R( __fastcall *hktype )(Args&...);
    typedef typename R( C::*hktypeC )(Args&...);

    //
    // Workaround for void return type
    //
    typedef typename ReturnType( __fastcall *typeR )(Args...);
    typedef typename ReturnType( __fastcall *hktypeR )(Args&...);
