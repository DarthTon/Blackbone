...
public:
    ...
    virtual void SaveRetValAndSignalEvent( size_t ResultPtr, size_t EventPtr, size_t lastStatusPtr, eReturnType rtype = rt_int32 );
    ...
    {
        // mov rdx, gs:[0x30]   
        a._emitDWord( 0x148b4865 );
        a._emitDWord( 0x00003025 );
        a._emitByte( 0x00 );
    }
