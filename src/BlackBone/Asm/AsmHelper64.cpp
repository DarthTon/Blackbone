...
AsmHelper64::AsmHelper64()
    : IAsmHelper( asmjit::Environment::kArchX64 )
    , _stackEnabled( true )
{
}
    ...
    )
{
    ...
    // Save last NT status
    _assembler.mov( asmjit::x86::rdx, asmjit::x86::dword_ptr_abs( 0x30 ).setSegment( asmjit::x86::gs ) );    // TEB ptr
...
{
    static const asmjit::x86::Gp regs[] = { asmjit::x86::rcx, asmjit::x86::rdx, asmjit::x86::r8, asmjit::x86::r9 };
    static const asmjit::x86::Xmm xregs[] = { asmjit::x86::xmm0, asmjit::x86::xmm1, asmjit::x86::xmm2, asmjit::x86::xmm3 };
